...
```{r}
x = 500
random_graphs[[x]] %>% degree(gmode = "graph")  %>% mean()
out[[x]] %>% degree(gmode = "graph")  %>% mean()
out_inverse[[x]]  %>% degree(gmode = "graph") %>% mean()
```

```{r}
gplot(random_graphs[[x]], gmode = "graph")
gplot(out[[x]], gmode = "graph")
gplot(out_inverse[[x]], gmode = "graph")

```

```{r}
cutpoints(random_graphs[[x]], mode = "graph")
cutpoints(out[[x]], mode = "graph")
cutpoints(out_inverse[[x]], mode = "graph")
```

```{r}
component.dist(out_inverse[[x]])
```
